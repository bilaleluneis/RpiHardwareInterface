...
${OBJECTDIR}/dht11.o: dht11.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dht11.o dht11.c
...
${TESTDIR}/read.o: read.c 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/read.o read.c
...
${OBJECTDIR}/dht11_nomain.o: ${OBJECTDIR}/dht11.o dht11.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dht11_nomain.o dht11.c;\
	else  \
